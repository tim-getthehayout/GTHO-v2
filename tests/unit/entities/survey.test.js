/** @file Entity tests: survey */
import { describe, it, expect } from 'vitest';
import { FIELDS, create, validate, toSupabaseShape, fromSupabaseShape } from '../../../src/entities/survey.js';
...
describe('entity: survey', () => {
  ...
  describe('validate', () => {
    it('passes for valid record', () => {
      const r = create({ operationId: OP_ID, surveyDate: '2024-06-15', type: 'bulk' });
    ...
    it('fails for invalid type', () => {
      const r = create({ operationId: OP_ID, surveyDate: '2024-06-15', type: 'invalid' });
