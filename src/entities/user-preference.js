...
export const FIELDS = {
  ...
  activeFarmId:            { type: 'uuid',        required: false, sbColumn: 'active_farm_id' },
...
export function create(data = {}) {
  return {
    ...
    activeFarmId: data.activeFarmId ?? null,
...
export function toSupabaseShape(record) {
  return {
    ...
    active_farm_id: record.activeFarmId,
...
export function fromSupabaseShape(row) {
  return {
    ...
    activeFarmId: row.active_farm_id,
