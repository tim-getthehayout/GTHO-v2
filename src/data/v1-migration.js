...
export function transformV1ToV2(v1, opts) {
  ...
  const v2FarmSettings = [{
    ...
    threshold_aud_target_pct: settings.thresholds?.audsTargetPct || null,
    threshold_aud_warn_pct: settings.thresholds?.audsWarningPct || null,
    threshold_rotation_target_pct: settings.thresholds?.pasturePercentTarget || null,
    threshold_rotation_warn_pct: settings.thresholds?.pasturePercentWarn || null,
