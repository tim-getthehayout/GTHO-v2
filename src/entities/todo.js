...
export const FIELDS = {
  ...
  pointLat:    { type: 'numeric',     required: false, sbColumn: 'point_lat' },
  pointLng:    { type: 'numeric',     required: false, sbColumn: 'point_lng' },
...
export function create(data = {}) {
  return {
    ...
    pointLat:    data.pointLat    ?? null,
    pointLng:    data.pointLng    ?? null,
...
export function toSupabaseShape(record) {
  return {
    ...
    point_lat:    record.pointLat,
    point_lng:    record.pointLng,
...
export function fromSupabaseShape(row) {
  return {
    ...
    pointLat:    row.point_lat != null ? Number(row.point_lat) : null,
    pointLng:    row.point_lng != null ? Number(row.point_lng) : null,
