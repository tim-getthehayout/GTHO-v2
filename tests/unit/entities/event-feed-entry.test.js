/** @file Entity tests: event-feed-entry */
import { describe, it, expect } from 'vitest';
import { FIELDS, create, validate, toSupabaseShape, fromSupabaseShape } from '../../../src/entities/event-feed-entry.js';
...
describe('entity: event-feed-entry', () => {
  ...
  describe('validate', () => {
    it('passes for valid record', () => {
      const r = create({ operationId: OP_ID, eventId: EVT_ID, batchId: BATCH_ID, locationId: LOC_ID, date: '2024-06-01', quantity: 5 });
