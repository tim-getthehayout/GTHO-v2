/** @file Entity tests: harvest-event */
import { describe, it, expect } from 'vitest';
import { FIELDS, create, validate, toSupabaseShape, fromSupabaseShape } from '../../../src/entities/harvest-event.js';
...
describe('entity: harvest-event', () => {
  ...
  describe('validate', () => {
    it('passes for valid record', () => {
      const r = create({ operationId: OP_ID, date: '2024-07-15', notes: 'First cutting' });
