...
**Checkpoint:** ship as its own spec-file handoff. Spec: `github/issues/edit-paddock-window-observation-cards.md`. Small-surface UI addition — two shared components wired into one existing dialog. No schema change.
