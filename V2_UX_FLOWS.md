...
**Nav items:** Dashboard, Events, Locations, Animals, Feed, **Todos**, Reports, Settings. (V1 had 9 screens including Pastures and Feedback; v2 merges Pastures into Locations and moves Feedback to the header sub-row — see "Feedback & Help sub-row" above.)
