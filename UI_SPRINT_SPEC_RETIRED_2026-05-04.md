...
> **STATUS: RETIRED 2026-05-04.** All sprint specs (SP-1 through SP-14) have been reconciled into the base design docs across Sessions A (schema), B (P1 UX), and C (P2/P3 UX + architecture + infra + calc + design system). This file is preserved as the historical record of how those base-doc sections originated. The Reconciliation Checklist below shows the per-SP destinations.
>
> **Active design specs now live in the base docs.** Read those when implementing — not this file:
> - V2_UX_FLOWS.md (UX flows, screen designs, dialogs)
...
> - V2_CALCULATION_SPEC.md (formulas, helpers including `getLiveRemainingForMove`)
...
>
> Do **not** edit this file going forward. If a sprint-spec section turns out to need correction, fix the base doc and add a Change Log row there. **One open follow-up:** SP-9 (Survey Sheet v1 parity) merge into V2_UX_FLOWS.md §7 — deferred from Session C to a future Session D per the original Session C plan scope.
