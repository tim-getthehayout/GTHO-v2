/** @file Entity tests: event-feed-check */
import { describe, it, expect } from 'vitest';
import { FIELDS, create, validate, toSupabaseShape, fromSupabaseShape } from '../../../src/entities/event-feed-check.js';
...
describe('entity: event-feed-check', () => {
  ...
  describe('validate', () => {
    it('passes for valid record', () => {
      const r = create({ operationId: OP_ID, eventId: EVT_ID, date: '2024-06-01', isCloseReading: true });
