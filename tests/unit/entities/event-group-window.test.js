/** @file Entity tests: event-group-window */
import { describe, it, expect } from 'vitest';
import { FIELDS, create, validate, toSupabaseShape, fromSupabaseShape } from '../../../src/entities/event-group-window.js';
...
describe('entity: event-group-window', () => {
  ...
  describe('validate', () => {
    it('passes for valid record', () => {
      const r = create({ operationId: OP_ID, eventId: EVT_ID, groupId: GRP_ID, dateJoined: '2024-06-01', headCount: 50, avgWeightKg: 450 });
